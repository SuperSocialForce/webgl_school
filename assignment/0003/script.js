...
class ThreeApp {
  ...
  init() {
    ...
    this.earth.scale.setScalar(this.earthRadius*2.0); // 地球の大きさを設定
    ...
    this.satellite.position.set(this.earthRadius*1.05, 0.0, 0.0); // +Z の方向に初期位置を設定
  ...
  render() {
    ...
    // this.satellite.position.add(this.satellite.velocity);
